...
const Footer = () => {
  return (
    <footer className="w-full print:hidden ">
      <div className="flex items-center justify-between px-12 py-12 mx-auto">
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <small className="block text-sm text-center text-gray-400">
            © 2023 Mark Escolano, All rights reserved.
          </small>
        </div>
      </div>
    </footer>
